...
public class WebTableHandling {
	...
	public static void main(String[] args) {
        ...
        WebElement groupA = driver.findElement(By.xpath("/html/body/div[6]/div[1]/div[4]/div[2]/a"));
        js.executeScript("arguments[0].scrollIntoView();", groupA);
		...
		for (int i=1; i<=tbRowSize; i++)
		{
			...
			for (int j=1; j<=tbColumnSize; j++)
			{
				...
				if (tbData.getText().contains("Organisor"))
				{
					tbData.click();
				}
			}
